...
void Material::SetDiffuseColor( const DirectX::XMFLOAT3& diffuse )
{
    m_MaterialProperties->Diffuse = diffuse;
}

uint32_t Material::GetMaterialType() const
{
    return m_MaterialProperties->Type;
}

void Material::SetMaterialType( uint32_t type )
{
    m_MaterialProperties->Type = type;
}
...
bool Material::IsDIALECTIC() const
{
